...
public class MinimalPageRankNallapati {
  ...
  public static void main(String[] args) {
   ...
   PCollection<KV<String,String>> p1 = NallapatiMapper01(p,"go.md",dataFolder);
   PCollection<KV<String,String>> p2 = NallapatiMapper01(p,"python.md",dataFolder);
   PCollection<KV<String,String>> p3 = NallapatiMapper01(p,"java.md",dataFolder);
   PCollection<KV<String,String>> p4 = NallapatiMapper01(p,"README.md",dataFolder);
    ...
    pLinksString.apply(TextIO.write().to("NallapatiPR"));  
    p.run().waitUntilFinish();
  }

  public static PCollection<KV<String,String>> NallapatiMapper01(Pipeline p, String filename, String dataFolder){
