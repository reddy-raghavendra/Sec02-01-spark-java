...
public  class VotingPageTelluri extends DoFn<KV<String,Iterable<String>>,KV<String,RankedPageTelluri>> implements Serializable{
     ...
     * @param pageRank
     */
    public VotingPageTelluri(String voterName,Integer contributorVotes2, double pageRank){
