...
public  class VotingPageNalla extends DoFn<KV<String,Iterable<String>>,KV<String,RankedPageNalla>> implements Serializable{
    String voterName;
    int contributorVotes;
    double pageRank = 1.0;
    public VotingPageNalla(String voterName,Integer contributorVotes2, double pageRank){
